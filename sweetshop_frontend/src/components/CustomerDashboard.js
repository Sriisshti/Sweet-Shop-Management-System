      ...
      <div className="card h-100">
        ...
        <div className="card-body d-flex flex-column">
          ...
          <div className="mt-auto">
            ...
            <button
              className={`btn w-100 ${isOutOfStock ? 'btn-secondary disabled' : 'btn-primary'}`}
...
const Sidebar = ({ activeSection, setActiveSection, handleLogout, userName }) => {
  return (
    <div className="bg-light" style={{ width: '250px', minHeight: '100vh' }}>
      ...
      <div className="p-3">
        <div 
          className={`mb-2 p-2 rounded cursor-pointer ${activeSection === 'sweets' ? 'bg-primary text-white' : ''}`}
      ...
      <div className="flex-grow-1 p-4">
        {activeSection === 'sweets' && (
          <>
            {/* Header */}
            <div className="mb-4">
              <h2 className="fw-bold">Our Sweet Collection</h2>
              <p className="text-muted">Discover delicious Indian sweets</p>
            </div>
